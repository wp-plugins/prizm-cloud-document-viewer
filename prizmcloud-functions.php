	...
	<!--[if gt IE 8]><!--> <html class=\"no-js\"> <!--<![endif]-->
		<head>
			...
			<script type=\"text/javascript\" src=\"".JS_PLUGIN_URL."/jquery/jquery.js\"></script>";
                 if($wp_version < 3.9) {
		   echo "<script type=\"text/javascript\" src=\"".PRIZMCLOUD_WP_PLUGIN_URL."/js/tiny_mce_popup.js\"></script>";
                 }
		echo "	<script type=\"text/javascript\" src=\"".PRIZMCLOUD_WP_PLUGIN_URL."/js/prizmcloud-dialog.js\"></script>
		...
		<body>";
			...
			echo "<form id=\"formPrizmCloud\" method=\"post\">\r\n";
				...
				<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"5\">
					<tr>
						<td colspan=\"2\">
							...
							<textarea name=\"shortcode\" style=\"width:100%;\" cols=\"72\" rows=\"3\" id=\"shortcode\"></textarea>
						</td>
					</tr>
				</table>
			</fieldset>
			...
			<div class=\"mceActionPanel\">
				<div class=\"fl\"><input type=\"button\" id=\"insert\" name=\"insert\" value=\"Insert\" onclick=\"PrizmCloudInsertDialog.insert();\" /></div>";
                        if($wp_version < 3.9) {
				echo "<div class=\"fr\"><input type=\"button\" id=\"cancel\" name=\"cancel\" value=\"Cancel\" onclick=\"tinyMCEPopup.close();\"/></div>";
                        }
                        else {
                                echo "<div class=\"fr\"><input type=\"button\" id=\"cancel\" name=\"cancel\" value=\"Cancel\" onclick=\"PrizmCloudInsertDialog.close();\"/></div>";
                        }
			echo "</div>
			</form>
		</body>
